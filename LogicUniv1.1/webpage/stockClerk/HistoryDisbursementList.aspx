	...
	<div class="templatemo-container">
		...
		<div class="col-lg-9 col-md-9 col-sm-9  white-bg right-container" id="rightlayer">
			...
			<div class="tm-right-inner-container"> 
                ...
                <table class="table-products">
                     <tr>
                        ...
                        <td style="text-align: left">
                            ...
                            <asp:Button ID="Button1"  CssClass="btn btn-default btn-sm" runat="server" Text="Specify" OnClick="Button1_Click" />
                        </td>
                ...
                <%-- timepicker --%>        
                <div>
                    <asp:GridView CssClass="table table-bordered" ID="GridView1" width="900px" RowStyle-Height="35px"  HeaderStyle-Height="35px" Font-Size="Small" runat="server" OnPageIndexChanging="GridView1_PageIndexChanging" OnRowCommand="GridView1_RowCommand">
                        <Columns>
